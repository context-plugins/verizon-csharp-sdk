...
public class HyperPreciseLocationOptions
{
    ...
    {
        public string BaseUrl { get; set; } = "https://thingspace.verizon.com/api/hyper-precise/v1";
    }

    public class StagingOptions
    {
        public string BaseUrl { get; set; } = "https://staging.thingspace.verizon.com/api/hyper-precise/v1";
    }

    public class DevOptions
    {
        public string BaseUrl { get; set; } = "https://devmanagement-staging.thingspace.verizon.com:80/hyper-precise/v1";
    }

    public class QaOptions
    {
        public string BaseUrl { get; set; } = "https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api/hyper-precise/v1";
    }

    public class MockServerForLimitedAvailabilitySeeQuickStartOptions
    {
        public string BaseUrl { get; set; } = "https://mock-staging.thingspace.verizon.com/api/hyper-precise/v1";
    }
}
