...
[JsonConverter(typeof(V2TriggersRequest2Converter))]
public record V2TriggersRequest2
{
    ...
    private V2TriggersRequest2(Optional<AccountLevelCreateTriggerRequest> accountLevelCreateTriggerRequestValue,
    ...
    public static V2TriggersRequest2 AccountLevelCreateTriggerRequest(AccountLevelCreateTriggerRequest value) =>
    ...
    public static V2TriggersRequest2 AccountLevelObject(AccountLevelObject value) =>
        new(default, Optional<AccountLevelObject>.Some(value), default, default, default, default, default);

    public static V2TriggersRequest2 DeviceLevelCreateTriggerRequest(DeviceLevelCreateTriggerRequest value) =>
        new(default, default, Optional<DeviceLevelCreateTriggerRequest>.Some(value), default, default, default, default);

    public static V2TriggersRequest2 AccountGroupShareCreateTriggerRequest(AccountGroupShareCreateTriggerRequest value) =>
        new(default,
            default,
            default,
    ...
    public static V2TriggersRequest2 AccountShareCreateTriggerRequest(AccountShareCreateTriggerRequest value) =>
        new(default,
            default,
            default,
            default,
    ...
    public static V2TriggersRequest2 PayAsYouGoCreateTriggerRequest(PayAsYouGoCreateTriggerRequest value) =>
        new(default, default, default, default, default, Optional<PayAsYouGoCreateTriggerRequest>.Some(value), default);

    public static V2TriggersRequest2 Createtriggerchunk(Createtriggerchunk value) =>
    ...
    public static implicit operator V2TriggersRequest2(AccountLevelCreateTriggerRequest value) =>
        AccountLevelCreateTriggerRequest(value);

    public static implicit operator V2TriggersRequest2(AccountLevelObject value) => AccountLevelObject(value);

    public static implicit operator V2TriggersRequest2(DeviceLevelCreateTriggerRequest value) =>
        DeviceLevelCreateTriggerRequest(value);

    public static implicit operator V2TriggersRequest2(AccountGroupShareCreateTriggerRequest value) =>
        AccountGroupShareCreateTriggerRequest(value);

    public static implicit operator V2TriggersRequest2(AccountShareCreateTriggerRequest value) =>
        AccountShareCreateTriggerRequest(value);

    public static implicit operator V2TriggersRequest2(PayAsYouGoCreateTriggerRequest value) =>
        PayAsYouGoCreateTriggerRequest(value);

    public static implicit operator V2TriggersRequest2(Createtriggerchunk value) => Createtriggerchunk(value);
}

file sealed class V2TriggersRequest2Converter : JsonConverter<V2TriggersRequest2>
{
    public override V2TriggersRequest2 Read(ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options)
    {
        ...
        {
            return V2TriggersRequest2.AccountLevelCreateTriggerRequest(accountLevelCreateTriggerRequestValue);
        }
        if (JsonSerializer.TryDeserialize<AccountLevelObject>(root, options, out var accountLevelObjectValue))
        {
            return V2TriggersRequest2.AccountLevelObject(accountLevelObjectValue);
        }
        if (JsonSerializer.TryDeserialize<DeviceLevelCreateTriggerRequest>(root,
            options,
            out var deviceLevelCreateTriggerRequestValue))
        {
            return V2TriggersRequest2.DeviceLevelCreateTriggerRequest(deviceLevelCreateTriggerRequestValue);
        }
        ...
        {
            return V2TriggersRequest2.AccountGroupShareCreateTriggerRequest(accountGroupShareCreateTriggerRequestValue);
        }
        if (JsonSerializer.TryDeserialize<AccountShareCreateTriggerRequest>(root,
            options,
            out var accountShareCreateTriggerRequestValue))
        {
            return V2TriggersRequest2.AccountShareCreateTriggerRequest(accountShareCreateTriggerRequestValue);
        }
        if (JsonSerializer.TryDeserialize<PayAsYouGoCreateTriggerRequest>(root,
            options,
            out var payAsYouGoCreateTriggerRequestValue))
        {
            return V2TriggersRequest2.PayAsYouGoCreateTriggerRequest(payAsYouGoCreateTriggerRequestValue);
        }
        if (JsonSerializer.TryDeserialize<Createtriggerchunk>(root, options, out var createtriggerchunkValue))
        {
            return V2TriggersRequest2.Createtriggerchunk(createtriggerchunkValue);
        }
    ...
    public override void Write(Utf8JsonWriter writer, V2TriggersRequest2 value, JsonSerializerOptions options)
    {
        ...
        {
            throw new JsonException($"{nameof(V2TriggersRequest2)} contains no valid value to serialize.");
        }
    }
}
