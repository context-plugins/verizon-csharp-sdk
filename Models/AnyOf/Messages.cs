...
public record Messages
{
    ...
    private Messages(Optional<Message> messageValue,
    ...
    public static Messages Message(Message value) =>
        new(Optional<Message>.Some(value), default, default, default);

    public static Messages Message1(Message1 value) =>
        new(default, Optional<Message1>.Some(value), default, default);

    public static Messages Message2(Message2 value) =>
        new(default, default, Optional<Message2>.Some(value), default);

    public static Messages Message3(Message3 value) =>
    ...
    public static implicit operator Messages(Message value) => Message(value);

    public static implicit operator Messages(Message1 value) => Message1(value);

    public static implicit operator Messages(Message2 value) => Message2(value);

    public static implicit operator Messages(Message3 value) => Message3(value);
}

file sealed class MessagesConverter : JsonConverter<Messages>
{
    ...
    public override void Write(Utf8JsonWriter writer, Messages value, JsonSerializerOptions options)
    {
        ...
        {
            throw new JsonException($"{nameof(Messages)} contains no valid value to serialize.");
        }
    }
}
