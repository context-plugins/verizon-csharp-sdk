...
[JsonConverter(typeof(AccountLevelObjectconditionConverter))]
public record AccountLevelObjectcondition
{
    ...
    private AccountLevelObjectcondition(Optional<ConditionType> conditionTypeValue,
    ...
    public static AccountLevelObjectcondition ConditionType(ConditionType value) =>
        new(Optional<ConditionType>.Some(value), default);

    public static AccountLevelObjectcondition ConditionObjectCall(ConditionObjectCall value) =>
    ...
    public static implicit operator AccountLevelObjectcondition(ConditionType value) => ConditionType(value);

    public static implicit operator AccountLevelObjectcondition(ConditionObjectCall value) =>
        ConditionObjectCall(value);
}

file sealed class AccountLevelObjectconditionConverter : JsonConverter<AccountLevelObjectcondition>
{
    public override AccountLevelObjectcondition Read(ref Utf8JsonReader reader,
        Type typeToConvert,
        ...
        JsonSerializerOptions options)
    {
        ...
        {
            throw new JsonException($"{nameof(AccountLevelObjectcondition)} contains no valid value to serialize.");
        }
    }
}
