...
[JsonConverter(typeof(TriggerAttributesOptions1Converter))]
public record TriggerAttributesOptions1
{
    ...
    private TriggerAttributesOptions1(Optional<NotificationGroupNameTriggerAttribute> notificationGroupNameTriggerAttributeValue,
    ...
    public static TriggerAttributesOptions1 NotificationGroupNameTriggerAttribute(NotificationGroupNameTriggerAttribute value) =>
        new(Optional<NotificationGroupNameTriggerAttribute>.Some(value), default, default, default, default, default);

    public static TriggerAttributesOptions1 ServicePlanTriggerAttribute(ServicePlanTriggerAttribute value) =>
        new(default, Optional<ServicePlanTriggerAttribute>.Some(value), default, default, default, default);

    public static TriggerAttributesOptions1 DataPercentage50TriggerAttribute(DataPercentage50TriggerAttribute value) =>
        new(default, default, Optional<DataPercentage50TriggerAttribute>.Some(value), default, default, default);

    public static TriggerAttributesOptions1 DataPercentage75TriggerAttribute(DataPercentage75TriggerAttribute value) =>
        new(default, default, default, Optional<DataPercentage75TriggerAttribute>.Some(value), default, default);

    public static TriggerAttributesOptions1 DataPercentage90TriggerAttribute(DataPercentage90TriggerAttribute value) =>
        new(default, default, default, default, Optional<DataPercentage90TriggerAttribute>.Some(value), default);

    public static TriggerAttributesOptions1 DataPercentage100TriggerAttribute(DataPercentage100TriggerAttribute value) =>
    ...
    public static implicit operator TriggerAttributesOptions1(NotificationGroupNameTriggerAttribute value) =>
        NotificationGroupNameTriggerAttribute(value);

    public static implicit operator TriggerAttributesOptions1(ServicePlanTriggerAttribute value) =>
        ServicePlanTriggerAttribute(value);

    public static implicit operator TriggerAttributesOptions1(DataPercentage50TriggerAttribute value) =>
        DataPercentage50TriggerAttribute(value);

    public static implicit operator TriggerAttributesOptions1(DataPercentage75TriggerAttribute value) =>
        DataPercentage75TriggerAttribute(value);

    public static implicit operator TriggerAttributesOptions1(DataPercentage90TriggerAttribute value) =>
        DataPercentage90TriggerAttribute(value);

    public static implicit operator TriggerAttributesOptions1(DataPercentage100TriggerAttribute value) =>
        DataPercentage100TriggerAttribute(value);
}

file sealed class TriggerAttributesOptions1Converter : JsonConverter<TriggerAttributesOptions1>
{
    public override TriggerAttributesOptions1 Read(ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options)
    {
        ...
        {
            return TriggerAttributesOptions1.NotificationGroupNameTriggerAttribute(notificationGroupNameTriggerAttributeValue);
        }
        if (JsonSerializer.TryDeserialize<ServicePlanTriggerAttribute>(root,
            options,
            out var servicePlanTriggerAttributeValue))
        {
            return TriggerAttributesOptions1.ServicePlanTriggerAttribute(servicePlanTriggerAttributeValue);
        }
        if (JsonSerializer.TryDeserialize<DataPercentage50TriggerAttribute>(root,
            options,
            out var dataPercentage50TriggerAttributeValue))
        {
            return TriggerAttributesOptions1.DataPercentage50TriggerAttribute(dataPercentage50TriggerAttributeValue);
        }
        if (JsonSerializer.TryDeserialize<DataPercentage75TriggerAttribute>(root,
            options,
            out var dataPercentage75TriggerAttributeValue))
        {
            return TriggerAttributesOptions1.DataPercentage75TriggerAttribute(dataPercentage75TriggerAttributeValue);
        }
        if (JsonSerializer.TryDeserialize<DataPercentage90TriggerAttribute>(root,
            options,
            out var dataPercentage90TriggerAttributeValue))
        {
            return TriggerAttributesOptions1.DataPercentage90TriggerAttribute(dataPercentage90TriggerAttributeValue);
        }
        if (JsonSerializer.TryDeserialize<DataPercentage100TriggerAttribute>(root,
            options,
            out var dataPercentage100TriggerAttributeValue))
        {
            return TriggerAttributesOptions1.DataPercentage100TriggerAttribute(dataPercentage100TriggerAttributeValue);
        }
    ...
    public override void Write(Utf8JsonWriter writer,
        TriggerAttributesOptions1 value,
        JsonSerializerOptions options)
    {
        ...
        {
            throw new JsonException($"{nameof(TriggerAttributesOptions1)} contains no valid value to serialize.");
        }
    }
}
