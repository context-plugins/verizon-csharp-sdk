...
[JsonConverter(typeof(PricePlanTriggerConditionConverter))]
public record PricePlanTriggerCondition
{
    ...
    private PricePlanTriggerCondition(Optional<ConditionType> conditionTypeValue,
    ...
    public static PricePlanTriggerCondition ConditionType(ConditionType value) =>
        new(Optional<ConditionType>.Some(value), default);

    public static PricePlanTriggerCondition ConditionObjectCall(ConditionObjectCall value) =>
    ...
    public static implicit operator PricePlanTriggerCondition(ConditionType value) => ConditionType(value);

    public static implicit operator PricePlanTriggerCondition(ConditionObjectCall value) =>
        ConditionObjectCall(value);
}

file sealed class PricePlanTriggerConditionConverter : JsonConverter<PricePlanTriggerCondition>
{
    public override PricePlanTriggerCondition Read(ref Utf8JsonReader reader,
        Type typeToConvert,
        ...
        JsonSerializerOptions options)
    {
        ...
        {
            throw new JsonException($"{nameof(PricePlanTriggerCondition)} contains no valid value to serialize.");
        }
    }
}
