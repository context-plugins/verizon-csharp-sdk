...
public sealed class SensorInsightsSensorOffBoardingStatusRequestError : ApiError
{
    ...
    private SensorInsightsSensorOffBoardingStatusRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsSensorOffBoardingStatusRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsSensorOffBoardingStatusRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsSensorOffBoardingStatusRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsSensorOffBoardingStatusRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsSensorOffBoardingStatusRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsSensorOffBoardingStatusRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsSensorOffBoardingStatusRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsSensorOffBoardingStatusRequestErrorResponse : IErrorResponse<SensorInsightsSensorOffBoardingStatusRequestError>
{
    public static SensorInsightsSensorOffBoardingStatusRequestErrorResponse Instance { get; } = new();

    private SensorInsightsSensorOffBoardingStatusRequestErrorResponse()
    {
    }

    public Task<SensorInsightsSensorOffBoardingStatusRequestError> Map(HttpResponseMessage response,
        CancellationToken ct) => SensorInsightsSensorOffBoardingStatusRequestError.Create(response, ct);
}
