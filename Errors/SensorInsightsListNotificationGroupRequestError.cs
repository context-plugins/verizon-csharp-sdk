...
public sealed class SensorInsightsListNotificationGroupRequestError : ApiError
{
    ...
    private SensorInsightsListNotificationGroupRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsListNotificationGroupRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsListNotificationGroupRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsListNotificationGroupRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsListNotificationGroupRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsListNotificationGroupRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsListNotificationGroupRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsListNotificationGroupRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsListNotificationGroupRequestErrorResponse : IErrorResponse<SensorInsightsListNotificationGroupRequestError>
{
    public static SensorInsightsListNotificationGroupRequestErrorResponse Instance { get; } = new();

    private SensorInsightsListNotificationGroupRequestErrorResponse()
    {
    }

    public Task<SensorInsightsListNotificationGroupRequestError> Map(HttpResponseMessage response,
        CancellationToken ct) => SensorInsightsListNotificationGroupRequestError.Create(response, ct);
}
