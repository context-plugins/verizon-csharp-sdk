...
public sealed class SensorInsightsUpdateUserRequestError : ApiError
{
    ...
    private SensorInsightsUpdateUserRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsUpdateUserRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsUpdateUserRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsUpdateUserRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsUpdateUserRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsUpdateUserRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsUpdateUserRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsUpdateUserRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsUpdateUserRequestErrorResponse : IErrorResponse<SensorInsightsUpdateUserRequestError>
{
    public static SensorInsightsUpdateUserRequestErrorResponse Instance { get; } = new();

    private SensorInsightsUpdateUserRequestErrorResponse()
    {
    }

    public Task<SensorInsightsUpdateUserRequestError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorInsightsUpdateUserRequestError.Create(response, ct);
}
