...
public sealed class SensorInsightsPatchSmartAlertRequestError : ApiError
{
    ...
    private SensorInsightsPatchSmartAlertRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsPatchSmartAlertRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsPatchSmartAlertRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsPatchSmartAlertRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsPatchSmartAlertRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsPatchSmartAlertRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsPatchSmartAlertRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsPatchSmartAlertRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsPatchSmartAlertRequestErrorResponse : IErrorResponse<SensorInsightsPatchSmartAlertRequestError>
{
    public static SensorInsightsPatchSmartAlertRequestErrorResponse Instance { get; } = new();

    private SensorInsightsPatchSmartAlertRequestErrorResponse()
    {
    }

    public Task<SensorInsightsPatchSmartAlertRequestError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorInsightsPatchSmartAlertRequestError.Create(response, ct);
}
