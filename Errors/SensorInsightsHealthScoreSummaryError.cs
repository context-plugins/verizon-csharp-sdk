...
public sealed class SensorInsightsHealthScoreSummaryError : ApiError
{
    ...
    private SensorInsightsHealthScoreSummaryError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsHealthScoreSummaryError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default);

    private static SensorInsightsHealthScoreSummaryError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default);

    private static SensorInsightsHealthScoreSummaryError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default);

    private static SensorInsightsHealthScoreSummaryError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsHealthScoreSummaryError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsHealthScoreSummaryError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsHealthScoreSummaryErrorResponse : IErrorResponse<SensorInsightsHealthScoreSummaryError>
{
    public static SensorInsightsHealthScoreSummaryErrorResponse Instance { get; } = new();

    private SensorInsightsHealthScoreSummaryErrorResponse()
    {
    }

    public Task<SensorInsightsHealthScoreSummaryError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorInsightsHealthScoreSummaryError.Create(response, ct);
}
