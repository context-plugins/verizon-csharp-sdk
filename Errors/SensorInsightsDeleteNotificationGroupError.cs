...
public sealed class SensorInsightsDeleteNotificationGroupError : ApiError
{
    ...
    private SensorInsightsDeleteNotificationGroupError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsDeleteNotificationGroupError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default);

    private static SensorInsightsDeleteNotificationGroupError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default);

    private static SensorInsightsDeleteNotificationGroupError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default);

    private static SensorInsightsDeleteNotificationGroupError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default);

    private static SensorInsightsDeleteNotificationGroupError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsDeleteNotificationGroupError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsDeleteNotificationGroupErrorResponse : IErrorResponse<SensorInsightsDeleteNotificationGroupError>
{
    public static SensorInsightsDeleteNotificationGroupErrorResponse Instance { get; } = new();

    private SensorInsightsDeleteNotificationGroupErrorResponse()
    {
    }

    public Task<SensorInsightsDeleteNotificationGroupError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorInsightsDeleteNotificationGroupError.Create(response, ct);
}
