...
public sealed class SensorInsightsOnBoardSensorRequestError : ApiError
{
    ...
    private SensorInsightsOnBoardSensorRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsOnBoardSensorRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default);

    private static SensorInsightsOnBoardSensorRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default);

    private static SensorInsightsOnBoardSensorRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default);

    private static SensorInsightsOnBoardSensorRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsOnBoardSensorRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsOnBoardSensorRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsOnBoardSensorRequestErrorResponse : IErrorResponse<SensorInsightsOnBoardSensorRequestError>
{
    public static SensorInsightsOnBoardSensorRequestErrorResponse Instance { get; } = new();

    private SensorInsightsOnBoardSensorRequestErrorResponse()
    {
    }

    public Task<SensorInsightsOnBoardSensorRequestError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorInsightsOnBoardSensorRequestError.Create(response, ct);
}
