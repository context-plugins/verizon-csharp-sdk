...
public sealed class SensorInsightsListGatewayDevicesRequestError : ApiError
{
    ...
    private SensorInsightsListGatewayDevicesRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsListGatewayDevicesRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsListGatewayDevicesRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsListGatewayDevicesRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsListGatewayDevicesRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsListGatewayDevicesRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsListGatewayDevicesRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsListGatewayDevicesRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsListGatewayDevicesRequestErrorResponse : IErrorResponse<SensorInsightsListGatewayDevicesRequestError>
{
    public static SensorInsightsListGatewayDevicesRequestErrorResponse Instance { get; } = new();

    private SensorInsightsListGatewayDevicesRequestErrorResponse()
    {
    }

    public Task<SensorInsightsListGatewayDevicesRequestError> Map(HttpResponseMessage response,
        CancellationToken ct) => SensorInsightsListGatewayDevicesRequestError.Create(response, ct);
}
