...
public sealed class SensorInsightsUpdateNotificationGroupRequestError : ApiError
{
    ...
    private SensorInsightsUpdateNotificationGroupRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsUpdateNotificationGroupRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsUpdateNotificationGroupRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsUpdateNotificationGroupRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsUpdateNotificationGroupRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsUpdateNotificationGroupRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsUpdateNotificationGroupRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsUpdateNotificationGroupRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsUpdateNotificationGroupRequestErrorResponse : IErrorResponse<SensorInsightsUpdateNotificationGroupRequestError>
{
    public static SensorInsightsUpdateNotificationGroupRequestErrorResponse Instance { get; } = new();

    private SensorInsightsUpdateNotificationGroupRequestErrorResponse()
    {
    }

    public Task<SensorInsightsUpdateNotificationGroupRequestError> Map(HttpResponseMessage response,
        CancellationToken ct) => SensorInsightsUpdateNotificationGroupRequestError.Create(response, ct);
}
