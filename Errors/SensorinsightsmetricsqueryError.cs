...
public sealed class SensorinsightsmetricsqueryError : ApiError
{
    ...
    private SensorinsightsmetricsqueryError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorinsightsmetricsqueryError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default);

    private static SensorinsightsmetricsqueryError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default);

    private static SensorinsightsmetricsqueryError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default);

    private static SensorinsightsmetricsqueryError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorinsightsmetricsqueryError AsFallback(RawError value) =>
    ...
    internal static Task<SensorinsightsmetricsqueryError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class SensorinsightsmetricsqueryErrorResponse : IErrorResponse<SensorinsightsmetricsqueryError>
{
    public static SensorinsightsmetricsqueryErrorResponse Instance { get; } = new();

    private SensorinsightsmetricsqueryErrorResponse()
    {
    }

    public Task<SensorinsightsmetricsqueryError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorinsightsmetricsqueryError.Create(response, ct);
}
