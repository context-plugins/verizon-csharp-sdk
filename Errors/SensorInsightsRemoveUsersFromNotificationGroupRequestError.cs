...
public sealed class SensorInsightsRemoveUsersFromNotificationGroupRequestError : ApiError
{
    ...
    private SensorInsightsRemoveUsersFromNotificationGroupRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsRemoveUsersFromNotificationGroupRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsRemoveUsersFromNotificationGroupRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsRemoveUsersFromNotificationGroupRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsRemoveUsersFromNotificationGroupRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsRemoveUsersFromNotificationGroupRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsRemoveUsersFromNotificationGroupRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsRemoveUsersFromNotificationGroupRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsRemoveUsersFromNotificationGroupRequestErrorResponse : IErrorResponse<SensorInsightsRemoveUsersFromNotificationGroupRequestError>
{
    public static SensorInsightsRemoveUsersFromNotificationGroupRequestErrorResponse Instance { get; } = new();

    private SensorInsightsRemoveUsersFromNotificationGroupRequestErrorResponse()
    {
    }

    public Task<SensorInsightsRemoveUsersFromNotificationGroupRequestError> Map(HttpResponseMessage response,
        CancellationToken ct) =>
        SensorInsightsRemoveUsersFromNotificationGroupRequestError.Create(response, ct);
}
