...
public sealed class SensorInsightsPatchDeviceRequestError : ApiError
{
    ...
    private SensorInsightsPatchDeviceRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsPatchDeviceRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsPatchDeviceRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsPatchDeviceRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsPatchDeviceRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsPatchDeviceRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsPatchDeviceRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsPatchDeviceRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsPatchDeviceRequestErrorResponse : IErrorResponse<SensorInsightsPatchDeviceRequestError>
{
    public static SensorInsightsPatchDeviceRequestErrorResponse Instance { get; } = new();

    private SensorInsightsPatchDeviceRequestErrorResponse()
    {
    }

    public Task<SensorInsightsPatchDeviceRequestError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorInsightsPatchDeviceRequestError.Create(response, ct);
}
