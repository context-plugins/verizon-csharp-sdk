...
public sealed class SensorInsightsListRulesRequestError : ApiError
{
    ...
    private SensorInsightsListRulesRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsListRulesRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsListRulesRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsListRulesRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsListRulesRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsListRulesRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsListRulesRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsListRulesRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsListRulesRequestErrorResponse : IErrorResponse<SensorInsightsListRulesRequestError>
{
    public static SensorInsightsListRulesRequestErrorResponse Instance { get; } = new();

    private SensorInsightsListRulesRequestErrorResponse()
    {
    }

    public Task<SensorInsightsListRulesRequestError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorInsightsListRulesRequestError.Create(response, ct);
}
