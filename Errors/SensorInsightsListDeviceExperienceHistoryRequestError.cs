...
public sealed class SensorInsightsListDeviceExperienceHistoryRequestError : ApiError
{
    ...
    private SensorInsightsListDeviceExperienceHistoryRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsListDeviceExperienceHistoryRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsListDeviceExperienceHistoryRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsListDeviceExperienceHistoryRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsListDeviceExperienceHistoryRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsListDeviceExperienceHistoryRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsListDeviceExperienceHistoryRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsListDeviceExperienceHistoryRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsListDeviceExperienceHistoryRequestErrorResponse : IErrorResponse<SensorInsightsListDeviceExperienceHistoryRequestError>
{
    public static SensorInsightsListDeviceExperienceHistoryRequestErrorResponse Instance { get; } = new();

    private SensorInsightsListDeviceExperienceHistoryRequestErrorResponse()
    {
    }

    public Task<SensorInsightsListDeviceExperienceHistoryRequestError> Map(HttpResponseMessage response,
        CancellationToken ct) => SensorInsightsListDeviceExperienceHistoryRequestError.Create(response, ct);
}
