...
public sealed class SensorInsightsListSmartAlertsRequestError : ApiError
{
    ...
    private SensorInsightsListSmartAlertsRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsListSmartAlertsRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsListSmartAlertsRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsListSmartAlertsRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsListSmartAlertsRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsListSmartAlertsRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsListSmartAlertsRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsListSmartAlertsRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsListSmartAlertsRequestErrorResponse : IErrorResponse<SensorInsightsListSmartAlertsRequestError>
{
    public static SensorInsightsListSmartAlertsRequestErrorResponse Instance { get; } = new();

    private SensorInsightsListSmartAlertsRequestErrorResponse()
    {
    }

    public Task<SensorInsightsListSmartAlertsRequestError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorInsightsListSmartAlertsRequestError.Create(response, ct);
}
