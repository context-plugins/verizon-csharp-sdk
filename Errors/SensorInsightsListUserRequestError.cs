...
public sealed class SensorInsightsListUserRequestError : ApiError
{
    ...
    private SensorInsightsListUserRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsListUserRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsListUserRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsListUserRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsListUserRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsListUserRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsListUserRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsListUserRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsListUserRequestErrorResponse : IErrorResponse<SensorInsightsListUserRequestError>
{
    public static SensorInsightsListUserRequestErrorResponse Instance { get; } = new();

    private SensorInsightsListUserRequestErrorResponse()
    {
    }

    public Task<SensorInsightsListUserRequestError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorInsightsListUserRequestError.Create(response, ct);
}
