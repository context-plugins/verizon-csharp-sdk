...
public sealed class SensorInsightsAddUsersToNotificationGroupRequestError : ApiError
{
    ...
    private SensorInsightsAddUsersToNotificationGroupRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsAddUsersToNotificationGroupRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsAddUsersToNotificationGroupRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsAddUsersToNotificationGroupRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsAddUsersToNotificationGroupRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsAddUsersToNotificationGroupRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsAddUsersToNotificationGroupRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsAddUsersToNotificationGroupRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsAddUsersToNotificationGroupRequestErrorResponse : IErrorResponse<SensorInsightsAddUsersToNotificationGroupRequestError>
{
    public static SensorInsightsAddUsersToNotificationGroupRequestErrorResponse Instance { get; } = new();

    private SensorInsightsAddUsersToNotificationGroupRequestErrorResponse()
    {
    }

    public Task<SensorInsightsAddUsersToNotificationGroupRequestError> Map(HttpResponseMessage response,
        CancellationToken ct) => SensorInsightsAddUsersToNotificationGroupRequestError.Create(response, ct);
}
