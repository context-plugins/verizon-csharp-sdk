...
public sealed class SensorInsightsOverwriteRuleRequestError : ApiError
{
    ...
    private SensorInsightsOverwriteRuleRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsOverwriteRuleRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsOverwriteRuleRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsOverwriteRuleRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsOverwriteRuleRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsOverwriteRuleRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsOverwriteRuleRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsOverwriteRuleRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsOverwriteRuleRequestErrorResponse : IErrorResponse<SensorInsightsOverwriteRuleRequestError>
{
    public static SensorInsightsOverwriteRuleRequestErrorResponse Instance { get; } = new();

    private SensorInsightsOverwriteRuleRequestErrorResponse()
    {
    }

    public Task<SensorInsightsOverwriteRuleRequestError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorInsightsOverwriteRuleRequestError.Create(response, ct);
}
