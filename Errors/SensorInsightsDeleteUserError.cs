...
public sealed class SensorInsightsDeleteUserError : ApiError
{
    ...
    private SensorInsightsDeleteUserError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsDeleteUserError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default);

    private static SensorInsightsDeleteUserError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default);

    private static SensorInsightsDeleteUserError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default);

    private static SensorInsightsDeleteUserError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default);

    private static SensorInsightsDeleteUserError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsDeleteUserError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class SensorInsightsDeleteUserErrorResponse : IErrorResponse<SensorInsightsDeleteUserError>
{
    public static SensorInsightsDeleteUserErrorResponse Instance { get; } = new();

    private SensorInsightsDeleteUserErrorResponse()
    {
    }

    public Task<SensorInsightsDeleteUserError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorInsightsDeleteUserError.Create(response, ct);
}
