...
public sealed class SensorInsightsSensorOnBoardStatusRequestError : ApiError
{
    ...
    private SensorInsightsSensorOnBoardStatusRequestError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsSensorOnBoardStatusRequestError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsSensorOnBoardStatusRequestError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsSensorOnBoardStatusRequestError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsSensorOnBoardStatusRequestError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsSensorOnBoardStatusRequestError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsSensorOnBoardStatusRequestError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsSensorOnBoardStatusRequestError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsSensorOnBoardStatusRequestErrorResponse : IErrorResponse<SensorInsightsSensorOnBoardStatusRequestError>
{
    public static SensorInsightsSensorOnBoardStatusRequestErrorResponse Instance { get; } = new();

    private SensorInsightsSensorOnBoardStatusRequestErrorResponse()
    {
    }

    public Task<SensorInsightsSensorOnBoardStatusRequestError> Map(HttpResponseMessage response,
        CancellationToken ct) => SensorInsightsSensorOnBoardStatusRequestError.Create(response, ct);
}
