...
public sealed class SensorInsightsGetNetworkHealthScoreResponseError : ApiError
{
    ...
    private SensorInsightsGetNetworkHealthScoreResponseError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsGetNetworkHealthScoreResponseError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default);

    private static SensorInsightsGetNetworkHealthScoreResponseError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default);

    private static SensorInsightsGetNetworkHealthScoreResponseError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default);

    private static SensorInsightsGetNetworkHealthScoreResponseError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsGetNetworkHealthScoreResponseError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsGetNetworkHealthScoreResponseError> Create(HttpResponseMessage response,
...
internal sealed class SensorInsightsGetNetworkHealthScoreResponseErrorResponse : IErrorResponse<SensorInsightsGetNetworkHealthScoreResponseError>
{
    public static SensorInsightsGetNetworkHealthScoreResponseErrorResponse Instance { get; } = new();

    private SensorInsightsGetNetworkHealthScoreResponseErrorResponse()
    {
    }

    public Task<SensorInsightsGetNetworkHealthScoreResponseError> Map(HttpResponseMessage response,
        CancellationToken ct) => SensorInsightsGetNetworkHealthScoreResponseError.Create(response, ct);
}
