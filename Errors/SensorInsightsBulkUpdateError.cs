...
public sealed class SensorInsightsBulkUpdateError : ApiError
{
    ...
    private SensorInsightsBulkUpdateError(Optional<ManagementError400> managementError400Value,
    ...
    private static SensorInsightsBulkUpdateError AsManagementError400(ManagementError400 value) =>
        new(Optional<ManagementError400>.Some(value), default, default, default, default, default);

    private static SensorInsightsBulkUpdateError AsManagementError(ManagementError value) =>
        new(default, Optional<ManagementError>.Some(value), default, default, default, default);

    private static SensorInsightsBulkUpdateError AsManagementError403(ManagementError403 value) =>
        new(default, default, Optional<ManagementError403>.Some(value), default, default, default);

    private static SensorInsightsBulkUpdateError AsManagementError404(ManagementError404 value) =>
        new(default, default, default, Optional<ManagementError404>.Some(value), default, default);

    private static SensorInsightsBulkUpdateError AsManagementError500(ManagementError500 value) =>
        new(default, default, default, default, Optional<ManagementError500>.Some(value), default);

    private static SensorInsightsBulkUpdateError AsFallback(RawError value) =>
    ...
    internal static Task<SensorInsightsBulkUpdateError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class SensorInsightsBulkUpdateErrorResponse : IErrorResponse<SensorInsightsBulkUpdateError>
{
    public static SensorInsightsBulkUpdateErrorResponse Instance { get; } = new();

    private SensorInsightsBulkUpdateErrorResponse()
    {
    }

    public Task<SensorInsightsBulkUpdateError> Map(HttpResponseMessage response, CancellationToken ct) =>
        SensorInsightsBulkUpdateError.Create(response, ct);
}
